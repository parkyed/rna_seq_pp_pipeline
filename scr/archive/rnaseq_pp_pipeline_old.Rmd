...
## path to protect dataset

protect.data.path <- "/Users/ep/Documents/1_datasets/dataset_pearth/an0304/output/v2/"

## read the sample information file, and ensure sorted by analysisID

sample.info <- read.table(file = paste(protect.data.path, "targets_preprocessed.csv", sep=""), sep = ",", quote = "", check.names = F) %>%
  arrange(analysisID)
...
## Median - Ratio Normalisation + VST transformation with DESeq2
